...
function LoginModal({ onClose }) {
  return (
    <div className="absolute inset-0 z-50 flex flex-wrap items-center justify-center bg-black/50">
      ...
      <div className="px-4 py-2 w-130 h-170 bg-n-50 rounded-xl">
        <button 
        ...
        <input type="email" placeholder="Email" name="email" className="w-full mb-5 h-[8%] rounded-xl text-sl font-light md:text-xl cursor-pointer border border-p-600 text-n-700 px-2 flex justify-center items-center"/>
        <input type="password" placeholder="Password" name="password_hash" className="w-full mb-5 h-[8%] rounded-xl text-sl font-light md:text-xl cursor-pointer border border-p-600 text-n-700 px-2 flex justify-center items-center"/>
        ...
        <p className="text-sm font-light md:text-2xl font-grostek text-n-700">Did you get account ? <span className="font-bold">Register Here</span></p>
      </div>
    </div>
  );
}
